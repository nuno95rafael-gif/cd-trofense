    ...
    <form onSubmit={submit} className="space-y-6">
      <Card className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Field label="Posição"><Input data-testid="athlete-position" value={v.posicao} onChange={set("posicao")} placeholder="Médio, Avançado…" /></Field>
          <Field label="Sexo">
          ...
          <Field label="Etnia">
            <Select value={v.etnia} onValueChange={set("etnia")}>
              ...
              <SelectContent>
                ...
                <SelectItem value="hispanico">Hispânico</SelectItem>
              </SelectContent>
            </Select>
          </Field>
      ...
      <Card className="p-6">
        <h3 className="font-display text-xl font-bold mb-4">Preferências e hábitos</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Field label="Dieta"><Input data-testid="athlete-diet" value={v.dieta} onChange={set("dieta")} /></Field>
          ...
          <Field label="Preferência dia de jogo"><Input value={v.preferencia_jogo} onChange={set("preferencia_jogo")} /></Field>
